...
public:
    ...
    Igrac(bool p, int bp, QGraphicsTextItem* bod, QGraphicsTextItem* bel, QGraphicsTextItem* pobj, int pobj2)
    {
        potez = p; broj_punata = bp; bodovi = bod; bele = bel; br_pobjeda = pobj; broj_pobjeda = pobj2;
    }
...
int main(int argc, char* argv[])
{
    ...
    Igrac* igrac1 = new Igrac(false, 0, igrac_bodovi, igrac_bele, igrac_pobjede, 0);
    Igrac* igrac2 = new Igrac(false, 0, komp_bodovi, komp_bele, komp_pobjede, 0);
